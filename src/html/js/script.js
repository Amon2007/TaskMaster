...
// lets add categories tasks with js
let categories = [
  {
    title: "Personal",
    img: "person.png",
...
const renderTasks = () => {
  ...
  // if no tasks for selected category
  if (categoryTasks.length === 0) {
    tasksContainer.innerHTML = `
    <p class="no-task">No tasks for selected category</p>
  `;
  } else {
    categoryTasks.forEach((task) => {
      ...
      // add comletion functionality on click chekbox
...
// lets add functionlity to add new tasks
